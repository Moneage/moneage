                ...
                <ArticleReader>
                    {article.content ? (
                        ...
                        typeof article.content === 'string' ? (
                            ...
                            <div className="prose prose-slate max-w-none prose-headings:font-bold prose-h2:text-3xl prose-h3:text-2xl prose-p:text-slate-700 prose-p:leading-relaxed prose-a:text-blue-600 prose-strong:text-slate-900">
